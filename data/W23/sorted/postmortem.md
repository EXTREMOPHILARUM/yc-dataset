...
The company is listed as "Inactive" on the Y Combinator company directory, and its product domain, getsorted.io, returns no accessible content.<sup><a href="https://www.ycombinator.com/companies/sorted">[3]</a></sup> No acquisition, pivot, or public post-mortem has been identified. The founders have not published any retrospective, leaving the precise shutdown date and circumstances unknown.

<report-gallery>
<media-image src="https://images.crunchbase.com/image/upload/c_lpad,h_256,w_256,f_auto,q_auto:eco,dpr_1/dis8h2x29m8v5xqmrb01" alt="Luis Espinosa - Co-Founder & CEO of Sorted" caption="Luis Espinosa, Co-Founder & CEO of Sorted — one of only two people who built the product from Copenhagen before YC W23."></media-image>
</report-gallery>

## Founding Story

Sorted was founded in 2022 by a two-person team based in Copenhagen, Denmark.<sup><a href="https://www.ycombinator.com/companies/sorted">[4]</a></sup> The founder names are not publicly listed on the Y Combinator company page — the founder field appears blank — which is unusual even for early-stage YC companies and limits any direct assessment of domain expertise or prior execution track record.<sup><a href="https://www.ycombinator.com/companies/sorted">[5]</a></sup> Crunchbase identifies Luis Espinosa as Co-Founder and CEO, though no further biographical detail is publicly available for him or any co-founder.
...
- **2022** — Sorted founded in Copenhagen, Denmark by a 2-person team.<sup>[[4]](https://www.ycombinator.com/companies/sorted)</sup>
- **January 2023** — Sorted enters Y Combinator's Winter 2023 batch; receives pre-seed investment from YC. No funding amount disclosed.<sup>[[7]](https://www.crunchbase.com/organization/sorted-23e0)</sup>
- **2023** — Product goes live at getsorted.io, offering automated SaaS management for startups with a claimed 2-minute setup time.<sup>[[6]](https://www.crunchbase.com/organization/sorted-23e0)</sup>
- **2023–2024** — Company becomes inactive. YC directory lists status as "Inactive." Product domain returns no accessible content. Exact shutdown date unknown.<sup>[[3]](https://www.ycombinator.com/companies/sorted)</sup><sup>[[8]](https://getsorted.io/)</sup>
...
Sorted's stated approach was to automate the entire management layer. Its feature set, as described in public listings, covered six primary use cases:<sup><a href="https://www.ycombinator.com/companies/sorted">[9]</a></sup>
...
The claimed two-minute setup time was the product's most distinctive marketing claim.<sup><a href="https://www.crunchbase.com/organization/sorted-23e0">[6]</a></sup> In a category where competing products often require weeks of integration work, IT involvement, and data mapping, a near-instant onboarding experience would represent a genuine differentiator — if it was real. Whether this claim reflected actual product capability or aspirational positioning cannot be verified from available public data. No product screenshots, demo recordings, or archived landing pages are available to assess actual feature depth or UX quality.
...
Sorted wound down without any public announcement, post-mortem, or founder retrospective. The domain is inactive, the YC listing shows "Inactive" status, and no trace of the company appears in press coverage, Hacker News, or founder social media.<sup><a href="https://www.ycombinator.com/companies/sorted">[3]</a></sup><sup><a href="https://getsorted.io/">[8]</a></sup> The absence of public discourse is consistent with a company that never achieved the distribution or community engagement needed to build organic growth loops — and that wound down before it had anything public to say.
...
1. [Y Combinator — Sorted Company Profile](https://www.ycombinator.com/companies/sorted)
2. [Crunchbase — Sorted Organization Profile](https://www.crunchbase.com/organization/sorted-23e0)
3. [getsorted.io — Product Domain (inactive)](https://getsorted.io/)
