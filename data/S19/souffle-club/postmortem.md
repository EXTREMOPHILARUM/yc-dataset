...
- **January 2017** — Pradeep Muthukrishnan co-founds HiDimensional, his first startup.<sup>[[6]](https://contactout.com/Pradeep-Muthukrishnan-7808913)</sup>
- **December 2018** — HiDimensional winds down; Muthukrishnan exits.<sup>[[6]](https://contactout.com/Pradeep-Muthukrishnan-7808913)</sup>
- **January 2019** — Souffle Club founded by Muthukrishnan, with Nikhil Gupta and Soumya Santhanakrishnan joining as co-founders.<sup>[[4]](https://contactout.com/Pradeep-Muthukrishnan-7808913)</sup>
- **Summer 2019** — Souffle Club accepted into Y Combinator S19 batch, described as a "10x better LinkedIn alternative with profiles >> resumes," headquartered in San Francisco.<sup>[[1]](https://www.ycombinator.com/companies/souffle-club)</sup> Product tagline "Rise above your resumé" in active use.<sup>[[2]](https://www.souffle.club/)</sup>
- **August 21, 2019** — TrustedFor (the pivot/rebrand of Souffle Club) closes a $150K seed round led by Y Combinator, with Form Capital and Frontier Ventures participating.<sup>[[10]](https://tracxn.com/d/companies/trustedfor/__gZJdT3zcJ2VFrqGsMkxUTwQyNxozl8Rg_pCWJmLI5q8)</sup>
- **Late 2019** — Company pivots or rebrands to TrustedFor, repositioning as an invite-only community of recommended founders, leaders, and high-potential talent in Silicon Valley, with peer recommendation mechanics and in-person events.<sup>[[8]](https://www.crunchbase.com/organization/trustedfor)</sup>
- **2020** — Co-founder Nikhil Gupta departs TrustedFor and joins Steady Health as Product and Growth, signaling team attrition before the formal wind-down.<sup>[[14]](https://theorg.com/org/atob/org-chart/nikhil-gupta)</sup>
- **December 2021** — Souffle Club / TrustedFor winds down after approximately three years of operation.<sup>[[16]](https://contactout.com/Pradeep-Muthukrishnan-7808913)</sup>
- **July 2022** — Pradeep Muthukrishnan joins DoorDash as Senior Staff Software Engineer.<sup>[[4]](https://contactout.com/Pradeep-Muthukrishnan-7808913)</sup>

## What They Built

### Phase 1: Souffle Club — The Profile-First LinkedIn Alternative
...
The tagline "Rise above your resumé" and the YC description "profiles >> resumes" both point to a product that prioritized qualitative depth over structured data.<sup><a href="https://www.ycombinator.com/companies/souffle-club">[1]</a></sup><sup><a href="https://www.souffle.club/">[2]</a></sup> In practice, this likely meant profiles that could surface personality, projects, recommendations, or skills in formats that LinkedIn's rigid field structure did not accommodate. The specific features — whether video introductions, portfolio embeds, narrative bios, or something else — are not documented in any surviving public source.
...
No product screenshots, archived UI captures, or feature walkthroughs have surfaced. The souffle.club domain was active during this period, but no Wayback Machine captures with substantive product detail are available in public records. The company's limited public content output — 11 Medium followers — suggests either a closed beta, a stealth launch, or minimal investment in content marketing.<sup><a href="https://medium.com/@souffleclub/following">[3]</a></sup>

### Phase 2: TrustedFor — The Invite-Only Recommendation Community

At some point in 2019 — likely around or shortly after YC Demo Day in August — the company pivoted to a substantially different product under the name TrustedFor. The YC company page for "TrustedFor" redirects to the Souffle Club description, confirming these are the same entity.<sup><a href="https://www.ycombinator.com/companies/trustedfor">[7]</a></sup>

TrustedFor was described as "an invite-only community of the most recommended founders, leaders, and high-potential talent in Silicon Valley."<sup><a href="https://www.crunchbase.com/organization/trustedfor">[8]</a></sup> The core mechanic shifted from profile creation to peer recommendation: members could post requests for expert recommendations, and the community would respond by surfacing relevant people. This is closer to a curated talent marketplace or a trust-graph network than a LinkedIn alternative.

The product also incorporated offline components — small group events and dinners — suggesting the team recognized that digital-only trust signals were insufficient and that in-person interaction was needed to build the community density that would make the recommendation mechanic valuable.<sup><a href="https://www.crunchbase.com/organization/trustedfor">[9]</a></sup>
...
TrustedFor's Phase 2 narrowed the target to a specific archetype: founders, senior leaders, and high-potential talent within the Silicon Valley ecosystem who were already embedded in high-trust referral networks and valued curated introductions over cold outreach.<sup><a href="https://www.crunchbase.com/organization/trustedfor">[8]</a></sup> This customer was more clearly defined, but also more likely to already have the informal networks that TrustedFor was trying to formalize.
...
TrustedFor's identified competitors were LinkedIn, XING, and Shapr.<sup><a href="https://tracxn.com/d/companies/trustedfor/__gZJdT3zcJ2VFrqGsMkxUTwQyNxozl8Rg_pCWJmLI5q8">[15]</a></sup> This list reveals the structural difficulty of the company's position.
...
### Primary Cause: The Network-Effect Trap
...
### Secondary Cause: Undercapitalization and the Runway Problem

$150K in total funding — the standard YC check at the time — was structurally insufficient to build a professional network from scratch in San Francisco in 2019.<sup><a href="https://tracxn.com/d/companies/trustedfor/__gZJdT3zcJ2VFrqGsMkxUTwQyNxozl8Rg_pCWJmLI5q8">[10]</a></sup>
...
### Tertiary Cause: Team Attrition Before Wind-Down

Nikhil Gupta, the Head of Product, departed TrustedFor in 2020 to join Steady Health — a full year before the company's December 2021 wind-down.<sup><a href="https://theorg.com/org/atob/org-chart/nikhil-gupta">[14]</a></sup> In a three-person company, losing the product lead is not a personnel setback — it is a structural event. The departure left Muthukrishnan and Santhanakrishnan (whose role is unconfirmed) to operate a community product that required active curation, event planning, and member engagement.
...
### Structural Factor: The "Feature, Not a Company" Problem
...
1. [Y Combinator — Souffle Club company page](https://www.ycombinator.com/companies/souffle-club)
2. [Souffle Club website (archived)](https://www.souffle.club/)
3. [Souffle Club Medium account](https://medium.com/@souffleclub/following)
4. [Pradeep Muthukrishnan — ContactOut profile](https://contactout.com/Pradeep-Muthukrishnan-7808913)
5. [Y Combinator — TrustedFor company page](https://www.ycombinator.com/companies/trustedfor)
6. [TrustedFor — Crunchbase](https://www.crunchbase.com/organization/trustedfor)
7. [TrustedFor — Tracxn](https://tracxn.com/d/companies/trustedfor/__gZJdT3zcJ2VFrqGsMkxUTwQyNxozl8Rg_pCWJmLI5q8)
8. [Nikhil Gupta — The Org](https://theorg.com/org/atob/org-chart/nikhil-gupta)
9. [Pradeep Muthukrishnan — Clay profile (South Park Commons)](https://clay.earth/profile/pradeep-muthukrishnan)
