...
- **Mediapipe-based open-source projects**: Free but fragmented, undocumented, and unsupported. Weakness: no Unity integration, no commercial support, no cross-platform abstraction.35:T8d0,
