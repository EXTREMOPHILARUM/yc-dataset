...
Go-to-market is direct: target Cursor and Claude communities, position as "the deploy button AI forgot," and win through speed and simplicity. Free tier gets you to 500 deployed sites in 60 days. Paid tier ($20/mo) unlocks custom domains, form handling, and analytics. The unit economics work because infrastructure costs are now negligible and the TAM is massive.
