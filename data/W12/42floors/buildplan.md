...
- **Industrious, Regus/IWG, Flex by JLL**: Flex operators with direct booking but no cross-operator search. A tenant cannot compare an Industrious space against a Regus space against a sublease on any single platform. This is the gap.
