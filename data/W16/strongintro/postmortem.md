# Research Report: StrongIntro

## Overview

StrongIntro was a San Francisco-based recruiting startup that participated in Y Combinator's Winter 2016 batch.The company built a referral-sourcing product that parsed employees' social and professional networks to surface warm candidates for open engineering roles, delivering results through in-person "sourcing parties" facilitated by a dedicated StrongIntro recruiter.

Founded by a 17-year-old high school dropout and a Thiel Fellow, the company attracted a credible roster of YC-adjacent customers—Segment, Teespring, Upstart, and others—and reported 15x–20x referral improvements at Demo Day.StrongIntro wound down approximately five months after Demo Day in August 2016.

The core failure was structural: the product required human labor to function at every step, making it a staffing and services business in practice, not the scalable SaaS tool the founders intended to build.When that mismatch became clear, the founders chose to wind down rather than pivot into a business model they had not set out to build.
...
- **December 2014** — Fouad Matin begins work on StrongIntro concept (per LinkedIn start date)<sup>[[2]](https://fouad.org/about)</sup>
- **January 2014 – January 2016** — Fouad Matin serves as a Thiel Fellow<sup>[[3]](https://contactout.com/Fouad-Matin-36549429)</sup>
- **2015** — StrongIntro formally founded; Tieshun Roquerre drops out of high school to join as co-founder<sup>[[7]](https://tracxn.com/d/companies/strongintro/__5s_vdrCw--HO28DME7Xx5wZYJ6zZKC-yaM2LxDeoTq0)</sup>
- **2015** — Roquerre joins, bringing prior engineering experience from Teespring, which becomes an early customer<sup>[[4]](https://decrypt.co/121950/blur-founder-pacman-high-school-mit-dropout)</sup>
- **January 2016** — StrongIntro enters Y Combinator Winter 2016 batch; Roquerre is 17, the youngest founder in the cohort<sup>[[5]](https://tieshunroquerre.com/blog/yc-learnings)</sup>
- **March 23, 2016** — StrongIntro demos at YC W16 Demo Day 2; raises $120K seed round led by Y Combinator; covered by TechCrunch<sup>[[8]](https://techcrunch.com/2016/03/23/y-combinator-winter-2016/)</sup>
- **March 23, 2016** — At Demo Day, StrongIntro reports 15x–20x referral improvements for Zesty and Teespring; active customers include Segment, Raise.me, Upstart, and OnboardIQ<sup>[[8]](https://techcrunch.com/2016/03/23/y-combinator-winter-2016/)</sup>
- **August 2016** — Fouad Matin departs StrongIntro and joins Segment as Engineering Lead; company effectively winds down<sup>[[2]](https://fouad.org/about)</sup>
- **2017** — Tieshun Roquerre enrolls at MIT studying Math and Computer Science<sup>[[9]](https://decrypt.co/121950/blur-founder-pacman-high-school-mit-dropout)</sup>
- **2018** — Roquerre drops out of MIT to found Namebase, a crypto domain startup; raises $5M, later sells to Namecheap<sup>[[9]](https://decrypt.co/121950/blur-founder-pacman-high-school-mit-dropout)</sup>
- **February 22, 2023** — Roquerre publicly connects his "Pacman" identity to his StrongIntro and YC W16 history in a widely-read tweet thread<sup>[[9]](https://decrypt.co/121950/blur-founder-pacman-high-school-mit-dropout)</sup>

<media-hn url="https://news.ycombinator.com/item?id=24355634" title="What I Learned Going Through YC as a 17 Year Old"></media-hn>
...
The core delivery mechanism was the "sourcing party"—a facilitated session held at the client's office.<sup><a href="https://www.ycombinator.com/blog/strongintro-yc-w16-boosts-employee-referrals-for-finding-and-hiring-engineers">[10]</a></sup> A dedicated StrongIntro recruiter would arrive at the company, gather a group of employees, and walk them through importing their professional and social contacts. Employees connected their email accounts, Facebook profiles, and LinkedIn networks to StrongIntro's software.<sup><a href="https://techcrunch.com/2016/03/23/y-combinator-winter-2016/">[11]</a></sup> The software then cross-referenced those contacts against the company's open job roles, surfacing second-degree connections who matched the hiring criteria.

The output metric StrongIntro cited was 50 to 100 warm candidates for every five employees who participated.<sup><a href="https://www.ycombinator.com/blog/strongintro-yc-w16-boosts-employee-referrals-for-finding-and-hiring-engineers">[12]</a></sup> "Warm" here meant that the candidate had a direct connection to a current employee—a meaningful signal in engineering recruiting, where cold outreach response rates are notoriously low.

**The Recruiter Layer**

Beyond the software, StrongIntro provided a dedicated recruiter who handled the human components of the process: educating employees on how to make effective referrals, crafting customized outreach messages to candidates, and implementing best practices for follow-through.<sup><a href="https://www.ycombinator.com/blog/strongintro-yc-w16-boosts-employee-referrals-for-finding-and-hiring-engineers">[10]</a></sup> This recruiter layer was not a minor add-on—it was central to the product's value proposition. Without it, the software alone would have produced a list of names with no mechanism to convert them into actual candidates.

**The Technical Stack**

StrongIntro's GitHub organization reveals the technical infrastructure behind the product: a web crawler (built on the open-source `gocrawl` framework), a Chrome extension likely used during sourcing parties to facilitate contact imports, and a Segment analytics proxy for tracking user behavior.<sup><a href="https://github.com/strongintro">[13]</a></sup> This stack was functional but relatively thin—consistent with a product where the software was a matching and parsing layer sitting on top of a human-facilitated workflow, rather than a fully automated pipeline.
...
StrongIntro's initial target was early-stage technology startups, specifically those actively hiring software engineers. The customer roster at Demo Day—Segment, Raise.me, Teespring, Upstart, OnboardIQ, and Zesty<sup><a href="https://www.ycombinator.com/blog/strongintro-yc-w16-boosts-employee-referrals-for-finding-and-hiring-engineers">[14]</a></sup><sup><a href="https://tracxn.com/d/companies/strongintro/__5s_vdrCw--HO28DME7Xx5wZYJ6zZKC-yaM2LxDeoTq0">[15]</a></sup>—was almost entirely composed of YC alumni or YC-adjacent companies. This was a natural starting point given the founders' network, but it also meant the customer base was geographically concentrated in San Francisco and socially concentrated within a single institutional network.
...
StrongIntro's Tracxn profile lists Teamable and RippleHire as direct competitors.<sup><a href="https://tracxn.com/d/companies/strongintro/__5s_vdrCw--HO28DME7Xx5wZYJ6zZKC-yaM2LxDeoTq0">[7]</a></sup> Both companies operated in the employee referral software space but took a more purely software-driven approach—automated reminders, gamification of referral programs, and integration with existing ATS platforms—rather than StrongIntro's high-touch, in-person model.

The broader competitive landscape included:

- **Traditional recruiting agencies**, which charged 15–25% placement fees but handled the full recruiting workflow, not just sourcing
- **LinkedIn Recruiter**, which gave in-house recruiters direct access to professional networks but required significant recruiter time to operate
- **Referral bonus programs**, which most companies already ran informally without software support
- **Sourcing tools** like Entelo and HiringSolved, which used software to identify passive candidates from public data
...
StrongIntro operated on a pure performance-fee model with zero upfront costs to the client.<sup><a href="https://www.ycombinator.com/blog/strongintro-yc-w16-boosts-employee-referrals-for-finding-and-hiring-engineers">[10]</a></sup> The company charged a 10% fee on the first year's base salary of any candidate hired through its platform,<sup><a href="https://techcrunch.com/2016/03/23/y-combinator-winter-2016/">[11]</a></sup> with a 90-day money-back guarantee if the hire did not work out.<sup><a href="https://tracxn.com/d/companies/strongintro/__5s_vdrCw--HO28DME7Xx5wZYJ6zZKC-yaM2LxDeoTq0">[7]</a></sup>

This pricing structure was customer-friendly by design: it eliminated procurement friction and aligned StrongIntro's incentives with the client's outcome. However, it created a significant cash flow problem for the company. StrongIntro bore the full cost of running each sourcing party—recruiter time, travel, tooling—before receiving any revenue. Revenue only materialized weeks or months later, after a candidate was sourced, interviewed, offered a role, accepted, and completed a 90-day probationary period. With only $120,000 in total funding<sup><a href="https://tracxn.com/d/companies/strongintro/__5s_vdrCw--HO28DME7Xx5wZYJ6zZKC-yaM2LxDeoTq0">[16]</a></sup> and two employees, the company had almost no financial runway to absorb the lag between service delivery and payment.

---

## Traction

By YC W16 Demo Day on March 23, 2016, StrongIntro had a credible and named customer list: Segment, Raise.me, Teespring, Upstart, OnboardIQ, and Zesty.<sup><a href="https://www.ycombinator.com/blog/strongintro-yc-w16-boosts-employee-referrals-for-finding-and-hiring-engineers">[14]</a></sup><sup><a href="https://tracxn.com/d/companies/strongintro/__5s_vdrCw--HO28DME7Xx5wZYJ6zZKC-yaM2LxDeoTq0">[15]</a></sup> The reported outcome metrics were strong: Zesty and Teespring each saw 15x to 20x more referrals through StrongIntro's sourcing parties compared to their prior referral programs.<sup><a href="https://techcrunch.com/2016/03/23/y-combinator-winter-2016/">[8]</a></sup>
...
StrongIntro wound down approximately five months after Demo Day. The failure was not a slow decline—it was a rapid recognition that the business being built was not the business the founders had set out to build. Fouad Matin's departure in August 2016 to join Segment as Engineering Lead marks the effective end of the company.<sup><a href="https://fouad.org/about">[2]</a></sup> No formal shutdown announcement was made.

### The Services Trap: A Structural Mismatch Between Model and Ambition
...
### Unit Economics That Could Not Support the Model
...
### What the Founders Did Not Try (As Far As Is Known)
...
1. [Tieshun Roquerre profile — Global From Asia](https://vip.globalfromasia.com/network/tieshun-roquerre/)
2. [Fouad Matin — About page (fouad.org)](https://fouad.org/about)
3. [Fouad Matin — ContactOut profile](https://contactout.com/Fouad-Matin-36549429)
4. [Blur founder Pacman: high school dropout, MIT dropout — Decrypt](https://decrypt.co/121950/blur-founder-pacman-high-school-mit-dropout)
5. [What I Learned Going Through YC as a 17 Year Old — Tieshun Roquerre](https://tieshunroquerre.com/blog/yc-learnings)
6. [StrongIntro YC W16 blog post — Y Combinator](https://www.ycombinator.com/blog/strongintro-yc-w16-boosts-employee-referrals-for-finding-and-hiring-engineers)
7. [StrongIntro company profile — Tracxn](https://tracxn.com/d/companies/strongintro/__5s_vdrCw--HO28DME7Xx5wZYJ6zZKC-yaM2LxDeoTq0)
8. [Y Combinator Winter 2016 Demo Day 2 — TechCrunch](https://techcrunch.com/2016/03/23/y-combinator-winter-2016/)
9. [StrongIntro — Y Combinator company page](https://www.ycombinator.com/companies/strongintro)
10. [StrongIntro — Crunchbase](https://www.crunchbase.com/organization/strongintro)
11. [StrongIntro — GitHub organization](https://github.com/strongintro)
12. [StrongIntro — YCDB](https://www.ycdb.co/company/strongintro)
13. [StrongIntro — Product Hunt](https://www.producthunt.com/products/strongintro)
14. [Fouad Matin — RocketReach profile](https://rocketreach.co/fouad-matin-email_2074826)
15. [StrongIntro.com — Wayback Machine archive](https://web.archive.org/web/20160404000000*/strongintro.com)
