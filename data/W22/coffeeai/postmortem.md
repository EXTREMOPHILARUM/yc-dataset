...
- **2019** — Company founded in Auckland, New Zealand as Segna by Will Haringa and Aryan Lobie.<sup>[[8]](https://www.ycombinator.com/companies/coffeeai)</sup>

- **January 2020** — Segna receives undisclosed pre-seed funding from CP Ventures (Crunchbase-recorded date; medium confidence).<sup>[[9]](https://www.crunchbase.com/organization/coffeeai)</sup>

- **November 26, 2021** — Segna closes a $125K seed round led by Y Combinator, part of NZ$880K total raised from Hillfarrance VC, Icehouse Ventures, and CP Ventures.<sup>[[5]](https://www.startupdaily.net/topic/accelerator/kiwi-data-wrangling-startup-segna-bags-us125000-seed-round-ahead-of-joining-the-y-combinator-accelerator/)</sup>

- **January 2022** — Segna enters Y Combinator's Winter 2022 batch as a data wrangling platform.<sup>[[8]](https://www.ycombinator.com/companies/coffeeai)</sup>

- **March 22, 2022** — CoffeeAI (Segna Inc.) receives $500K pre-seed investment from Y Combinator at YC W22 Demo Day.<sup>[[9]](https://www.crunchbase.com/organization/coffeeai)</sup>

- **May 21, 2022** — Startup Daily publishes a profile of the Segna founders, documenting their aerospace backgrounds and NZ$880K raise.<sup>[[2]](https://www.startupdaily.net/topic/accelerator/kiwi-data-wrangling-startup-segna-bags-us125000-seed-round-ahead-of-joining-the-y-combinator-accelerator/)</sup>
...
- **Late 2022 / Early 2023** — Company pivots from Segna (data wrangling) to CoffeeAI (AI sales outreach), launching a ChatGPT-powered Chrome extension for personalized LinkedIn messages and cold emails.<sup>[[10]](https://www.crunchbase.com/organization/coffeeai)</sup>

- **June 6, 2023** — Will Haringa publicly announces CoffeeAI's second Chrome Web Store review on LinkedIn, indicating the product is still in early user acquisition phase more than a year after YC Demo Day.<sup>[[11]](https://www.linkedin.com/posts/will-haringa_generativeai-sales-sdr-activity-7071971078100692992-IzC7)</sup>

- **June 2023** — CoffeeAI Chrome extension accumulates 269 ratings at 4.1/5 on the Chrome Web Store.<sup>[[12]](https://chromewebstore.google.com/detail/coffeeai-hyper-personaliz/ljganmjpdpdhihlanmnioaldnbgpokep?hl=en)</sup>

- **2024** — Will Haringa's LinkedIn lists him as working on a new stealth venture; Aryan Lobie's public profile reverts to the Segna identity.<sup>[[13]](https://theorg.com/org/segna/org-chart/will-haringa)</sup>

- **2024** — YC lists CoffeeAI as "Inactive"; Tracxn lists Segna (the legal entity) as "deadpooled." Company is definitively defunct.<sup>[[14]](https://tracxn.com/d/companies/segna/__Qlx65b29DD4ufiZ4T4Y6g5sFYdVBrJNrx989qBIxktY)</sup>

---

## What They Built

### The Original Product: Segna

Segna addressed a genuine pain point for data professionals: the tedious, manual process of pulling data from multiple sources—spreadsheets, databases, APIs—cleaning it, and preparing it for analysis. The platform used machine learning to automate this aggregation and cleaning process, promising to compress what might take hours into under a minute.<sup><a href="https://industry.aucklandnz.com/invest/news/hillfarrance-venture-capital-smart-capital-ai-first-tech-startups">[4]</a></sup> The target users were data analysts, data scientists, and business analysts—professionals who spent significant portions of their workday on data preparation rather than analysis.
...
The product was a Chrome extension, meaning it installed directly in the user's browser and activated on LinkedIn profiles and email composition windows.<sup><a href="https://chromewebstore.google.com/detail/coffeeai-hyper-personaliz/ljganmjpdpdhihlanmnioaldnbgpokep?hl=en">[12]</a></sup> The core workflow was straightforward:

1. A salesperson navigates to a prospect's LinkedIn profile or begins composing a cold email.
2. The CoffeeAI extension activates and reads publicly available information about the prospect—job title, company, recent activity, shared connections.
3. The user selects or configures a "Blueprint"—a template that encodes the specific call-to-action, value proposition, and tone they want the message to convey.<sup><a href="https://chromewebstore.google.com/detail/coffeeai-hyper-personaliz/ljganmjpdpdhihlanmnioaldnbgpokep?hl=en">[15]</a></sup>
4. CoffeeAI generates a fully personalized message in approximately 10 seconds, incorporating the prospect's specific context into the Blueprint's structure.
...
The product claimed to double response rates compared to generic outreach.<sup><a href="https://www.ycombinator.com/companies/coffeeai">[16]</a></sup> Whether this claim was validated by controlled data or was aspirational marketing copy is not documented.
...
The product's YC categories—Artificial Intelligence, SaaS, B2B, Sales, Sales Enablement—placed it squarely in a segment that was already attracting significant venture capital and founder attention before CoffeeAI launched.<sup><a href="https://www.ycombinator.com/companies/coffeeai">[17]</a></sup>
...
### 1. The Pivot Landed in a Commoditized Market at the Worst Possible Moment
...
### 2. Revenue Growth Stalled Far Below Venture Scale

The $30K ARR figure Haringa cited represents a meaningful early signal, but it also reveals the ceiling the product hit.<sup><a href="https://theorg.com/org/segna/org-chart/will-haringa">[18]</a></sup> For a YC-backed company that received $500K at Demo Day on top of NZ$880K in prior funding, $30K ARR is a proof-of-concept result, not a growth trajectory.
...
### 3. Geographic Distance from the Target Market

CoffeeAI's five-person team was based in Auckland, New Zealand, selling to US-based sales teams.<sup><a href="https://www.ycombinator.com/companies/coffeeai">[8]</a></sup> This created compounding disadvantages that are easy to underestimate.
...
### 4. The Quiet Wind-Down: No Follow-On Round, No Public Post-Mortem

By 2024, both founders had moved on. Haringa's LinkedIn listed him as working on a new stealth venture.<sup><a href="https://theorg.com/org/segna/org-chart/will-haringa">[13]</a></sup> Lobie's YC profile reverted to the Segna identity.<sup><a href="https://www.ycombinator.com/companies/coffeeai">[20]</a></sup> The company made no public shutdown announcement, issued no post-mortem, and no investor statement about the wind-down has been published.
...
1. [University of Auckland CIE — Segna's Lightning-Speed Data Wrangling Platform Gets Silicon Valley Investment](https://www.cie.auckland.ac.nz/newsroom/segnas-lightning-speed-data-wrangling-platform-gets-silicon-valley-investment/)
2. [Startup Daily — Kiwi data wrangling startup Segna bags US$125,000 seed round ahead of joining Y Combinator](https://www.startupdaily.net/topic/accelerator/kiwi-data-wrangling-startup-segna-bags-us125000-seed-round-ahead-of-joining-the-y-combinator-accelerator/)
3. [Crunchbase — CoffeeAI (Segna Inc.) company profile](https://www.crunchbase.com/organization/coffeeai)
4. [Invest Auckland / Auckland Economic Development — Hillfarrance Venture Capital: Smart Capital for AI-First Tech Startups](https://industry.aucklandnz.com/invest/news/hillfarrance-venture-capital-smart-capital-ai-first-tech-startups)
5. [Tracxn — Segna company profile (deadpooled)](https://tracxn.com/d/companies/segna/__Qlx65b29DD4ufiZ4T4Y6g5sFYdVBrJNrx989qBIxktY)
6. [Y Combinator — CoffeeAI company directory listing](https://www.ycombinator.com/companies/coffeeai)
7. [F6S — CoffeeAI company profile](https://www.f6s.com/company/coffeeai)
8. [Chrome Web Store — CoffeeAI: Hyper-Personalized Sales Emails extension listing](https://chromewebstore.google.com/detail/coffeeai-hyper-personaliz/ljganmjpdpdhihlanmnioaldnbgpokep?hl=en)
9. [The Org — Will Haringa profile at Segna/CoffeeAI](https://theorg.com/org/segna/org-chart/will-haringa)
10. [LinkedIn — Will Haringa post announcing CoffeeAI's second Chrome Web Store review (June 6, 2023)](https://www.linkedin.com/posts/will-haringa_generativeai-sales-sdr-activity-7071971078100692992-IzC7)
11. [Creati.ai — CoffeeAI: Hyper-Personalized Sales Emails tool listing](https://creati.ai/ai-tools/coffeeai-hyper-personalized-sales-emails/)
12. [Wayback Machine — Archive index for get-coffee.ai](https://web.archive.org/web/20230101000000*/get-coffee.ai)
13. [PitchBook — CoffeeAI company profile](https://pitchbook.com/profiles/company/442196-38)
14. [University of Auckland — Segna: Lightning-speed wrangling platform gets Silicon Valley investment (main news site)](https://www.auckland.ac.nz/en/news/2021/11/26/segna-lightning-speed-wrangling-platform-silicon-valley-investment.html)
15. [Hacker News — Submissions from segna.io domain](https://news.ycombinator.com/from?site=segna.io)
